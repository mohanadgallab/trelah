                        ...
                        <div class="row align-items-center">
                            <div class="col-md-3">
                                <div class="text-center border-end">
                                    <img src="{{ asset('services/' . $service->image_path) }}"
                                        class="img-fluid avatar-xxl rounded-circle" alt="">
                                    <h4 class="text-primary font-size-20 mt-3 mb-2">{{ $service->name }}</h4>
                            ...
                            <div class="col-md-9">
                                <div class="ms-3">
                                    <div>
                                        ...
                                        <p class="mb-0 text-muted">{{ substr($service->desc, 0, 500) }}</p>
                                    </div>
                                    <div class="row my-4">
                                        <div class="col-md-12">
                                            <div>
                                                <p class="text-muted mb-2 fw-medium"><i
                                                        class="mdi mdi-email-outline me-2"></i>{{ $service->created_at }}
                                                </p>
                    ...
                    <div class="tab-content p-4">
                        <div class="tab-pane active show" id="team-tab" role="tabpanel">
                            <h4 class="card-title mb-4">
                                Team
                                <button class="btn btn-secondary float-end" data-toggle="modal"
                                    data-target="#exampleModal">Create</button>
                            </h4>

                            <div class="row">
                                @foreach ($service->CoServices as $co)
                                    <div class="col-xl-4 col-md-6" id="team-3">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex mb-4">
                                                    <div class="flex-grow-1 align-items-start">
                                                        <img src="{{ asset('services/' . $co->image_path) }}" alt=""
                                                    ...
                                                    <div class="dropdown ms-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a class="dropdown-item text-danger leave-team" data-id="3"
                                                ...
                                                <div>
                                                    <h5 class="mb-1 font-size-17">{{ $co->name }}</h5>
                                                    <p class="text-muted  font-size-13 mb-0">{{ $co->desc }}</p>
                                                </div>
                                            </div>
                                            <!-- end card-body -->
                                        </div><!-- end card -->
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Add Subject To Services</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <select name="lang" class="form-control @error('lang') is-invalid @enderror">
                                        ...
                                        <option value="ar" {{ 'ar' == old('lang', $co->lang) ? 'selected' : '' }}>Arabic
                                        </option>

                                        <option value="en" {{ 'en' == old('lang', $co->lang) ? 'selected' : '' }}>
                                            English</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="desc" cols="20" class="form-control @error('desc') is-invalid @enderror">{{ old('desc', $co->desc) }}</textarea>
                                    @error('desc')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }} </strong>
                                        </span>
