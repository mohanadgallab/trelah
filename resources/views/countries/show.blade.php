            ...
            <div class="card-body pb-0">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-9">
                        <div class="ms-3">
                            <div>
                                <h4 class="card-title mb-2">{{ $country->name}}</h4><br/>
                                <p class="mb-0 text-muted">{{ substr($country->content, 0 ,200)}}</p>
                            </div>
                            <div class="row my-4">
                                <div class="col-md-12">
                                    <div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted  font-size-13 mb-0">{{substr($service->desc, 0, 200)}}</p>
                                    </div>
                                </div>
                                <!-- end card-body -->
                            </div><!-- end card -->
